# This Assignment: Lesson 3 — Colliding Sprites

PRIMM lesson on collision detection. `collide.py` has a player, enemy (chases), and collectible. Students explore then build their own in `tryit.py`.

**Student files**: `collide.py` (example), `tryit.py` (student work), `images/`
**Key concepts**: colliderect(), enemy chasing logic, collectible respawning
